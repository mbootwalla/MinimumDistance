...
index <- 1:7599
##myindexList <- splitIndicesByLength(c(1:3600, 5001:7599), 200)
myindexList <- splitIndicesByLength(c(1:3600, 5001:7599), 3000)
myindex <- myindexList[[sample.batch]]
source("genotype.Illumina2.R")
trace(genotype.Illumina2, browser)
cnSet <- genotype.Illumina2(batch=as.factor(rep(1, nrow(samplesheet)))[index],
