...
med.o <- median(freq.o)
freq.o[freq.o > 15] <- 15
hist(freq.o, xlim=c(0,15), breaks=40, main="offspring", xlab=paste("number of deletions in chr", CHR), xaxt="n", col="lightblue")
...
med.p <- median(freq.p)
freq.p[freq.p > 15] <- 15
hist(freq.p, xlim=c(0,25), breaks=40, main="parents", xlab=paste("number of deletions in chr", CHR), xaxt="n", col="lightblue")
axis(1, at=15, labels="15+")
axis(1, at=pretty(c(0, 14)), labels=pretty(c(0,14)))
